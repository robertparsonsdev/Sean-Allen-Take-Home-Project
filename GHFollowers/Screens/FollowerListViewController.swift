...
class FollowerListViewController: GFDataLoadingVC {
    ...
    @objc func favoriteButtonTapped() {
        ...
        NetworkManager.shared.getUserInfo(for: self.username) { [weak self] (result) in
            ...
            case .failure(let error): self.presentGFAlertOnMainThread(title: "Can't Favorite", message: error.rawValue, buttonTitle: "Okay")
            }
        }
    }
    ...
    func addUserToFavorites(user: User) {
        ...
        PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] (error) in
            ...
            guard let error = error else {
                self.presentGFAlertOnMainThread(title: "Success!", message: "You have successfully favorited this user!", buttonTitle: "Okay")
                return
            }
            self.presentGFAlertOnMainThread(title: "Can't Save Favorite", message: error.rawValue, buttonTitle: "Okay")
        }
    }
}
...
extension FollowerListViewController: UserInfoVCDelegate {
    func didRequestFollowers(forUsername username: String) {
        ...
        getFollowers(username: username, page: self.page)
    }
}
